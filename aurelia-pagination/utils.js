System.register(['aurelia-framework'], function (_export) {
  ...
  var PathObserver, computedProxyContext, ComputedProxyPropertyObserver;

  _export('createForwardLookup', createForwardLookup);

  _export('createForwardComputed', createForwardComputed);
  ...
  function createPathObserver(node, obsl) {
    ...
    return new PathObserver(left, function (val) {
      return val && obsl.getObserver(val, node.prop);
    }, left.getValue());
  }
  return {
    setters: [function (_aureliaFramework) {
      PathObserver = _aureliaFramework.PathObserver;
    }],
    execute: function () {
      computedProxyContext = 'ComputedProxyPropertyObserver';

      ComputedProxyPropertyObserver = (function () {
        ...
        ComputedProxyPropertyObserver.prototype.subscribe = (function (_subscribe) {
