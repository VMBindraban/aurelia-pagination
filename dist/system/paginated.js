System.register(['aurelia-framework', './utils'], function (_export) {
  ...
  var customElement, processContent, bindable, noView, ViewSlot, ViewResources, ViewCompiler, inject, Container, ObserverLocator, createForwardLookup, _ready, _counter, _prev, _subscription, PaginatedElement;
  ...
  return {
    ...
    execute: function () {
      _ready = Symbol('ready');
      _counter = Symbol('counter');
      _prev = Symbol('prev');
      _subscription = Symbol('subscription');

      PaginatedElement = (function () {
        ...
        PaginatedElement = inject(ViewResources, ViewSlot, ViewCompiler, Container, ObserverLocator, Element)(PaginatedElement) || PaginatedElement;
        PaginatedElement = customElement('paginated')(PaginatedElement) || PaginatedElement;
        PaginatedElement = processContent(false)(PaginatedElement) || PaginatedElement;
        PaginatedElement = noView()(PaginatedElement) || PaginatedElement;
        return PaginatedElement;
      })();

      _export('PaginatedElement', PaginatedElement);
    }
  };
});